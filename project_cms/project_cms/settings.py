...
SECRET_KEY = 'django-insecure-_^4n7a=qm$qfthu#d_3n%w%%11ph!riv(d+9egozcyo$g6l^ls'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [ 'localhost', '127.0.0.1', '51.250.109.99', 'emely.myddns.me']
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "project_cms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
