  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        SuccessDarkGreenStroke: '#0F1D0F',
        SuccessDarkGreenText: '#0E700E',
        WarningOrangeBg: '#4A1E04',
        WarningOrangeStroke: '#DE590B',
        WarningOrangeText: '#FDCFB4',
        DangerRedBg: '#3B0509',
        DangerRedStroke: '#C50F1F',
        DangerRedText: '#DC626D',
        DangerDarkRedStroke: '#3C1414',
        DangerDarkRedText: '#D13438',
        BrandBlueBg: '#082338',
        BrandBlueStroke: '#0E4775',
        BrandBlueText: '#62ABF5',
