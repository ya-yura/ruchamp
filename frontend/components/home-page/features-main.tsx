...
export function FeaturesMain() {
  return (
    <section className="h-[298px] w-full bg-[#090707]">
      <ContentWraper>
        <ScrollArea className="w-full whitespace-nowrap rounded-md">
          <ul className="flex w-max space-x-4 pb-10 pt-4">
            {features.map((feature) => (
              <li
                key={feature.title}
                className="group flex h-fit w-[308px] cursor-default flex-col rounded-lg bg-[#0D0D0D] px-6 py-8 transition-colors hover:bg-[#0F6CBD]"
              >
