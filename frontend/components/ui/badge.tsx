  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 cursor-pointer',
  {
    variants: {
      variant: {
        ...
        ruchampDefault:
          'border-transparent bg-[#242424] text-white hover:bg-[#242424]/80 px-4 text-base font-semibold',
        ruchampSelected:
          'border-transparent bg-[#E0E0E0] text-[#424242] hover:bg-[#E0E0E0]/80 px-4 text-base font-semibold',
      },
    },
    defaultVariants: {
      variant: 'default',
